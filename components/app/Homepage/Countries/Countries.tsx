...
export const Countries = () => {
	return (
		<div className="bg-white px-6 py-6 xl:px-30 xl:py-30">
			<div className="heading mb-12 flex flex-col lg:flex-row xl:items-center lg:justify-between items-center">
				<Text
					variant={"h2"}
			...
			<div className="mt-12 flex flex-col gap-6 xl:gap-4 justify-between lg:flex-row lg:flex-wrap xl:flex-nowrap">
				<div className="w-full lg:w-[48%] xl:w-1/3">
					<CountryCard
						badgeLabel="Apply"
						cardImg={Png.CountryBG1}
						variant="primary"
						label={" Application Deadline for India: 3th Nov 2024 "}
